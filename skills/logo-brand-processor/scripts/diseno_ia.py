...
def parse_args():
    ...
    parser.add_argument("--logo", default=DEFAULT_LOGO, help="Ruta del logo principal.")
    parser.add_argument("--foto", default=DEFAULT_FOTO, help="Ruta opcional de la foto.")
    parser.add_argument("--prefijo", default="", help="Prefijo opcional para los archivos generados.")
...
def ejecutar_todo():
    ...
    print("\n--- INICIANDO PRODUCCION LOGO BRAND PROCESSOR ---")
    ...
    for temp_name in [salidas["logo_negro_temp"], salidas["logo_blanco_temp"]]:
        if os.path.exists(temp_name):
            os.remove(temp_name)

    for i, color in enumerate(colores):
        run_magick(
            f'magick -size {MUESTRA_COLOR_SIZE} xc:"{color}" '
